...
public class Main {
    ...
    private static void crearEstudiante(){
        ...
        System.out.println("La nota definitiva del estudiante "+ estudiante1.getNombre()+" es: "
                + definitivaEstudiante1);
        System.out.println("La nota definitiva del estudiante "+ estudiante2.getNombre()+" es: "
                + definitivaEstudiante2);
        System.out.println("La nota definitiva del estudiante "+ estudiante3.getNombre()+" es: "
                + definitivaEstudiante3);
    ...
    //Método para calcular la definitiva del estudiante
